...
export default function ContentHomePage() {
    ...
    const banners = [
        ...
        {
            title: "Aumente seu limite do cartão de credito hoje com o Nu Limite Garantido",
                    ...
                    {atalhos.map((atalho, index) => (
                        <CarouselItem key={index} className="basis-1/4">
                            <div className="p-1 text-white  w-25 flex flex-col items-center justify-center">
                                ...
                                {atalho.mensage !== "" && (
                                    <span className="bg-primary p-1 text-[10px] rounded-[4px] fixed mt-5 w-fit">
                                        {atalho.mensage}
                                    </span>
                                )}
                    ...
                    {banners.map((banner, index) => (
                        <CarouselItem key={index} className="basis-1/1">
                            <Card className="p-2 ml-8 mr-8 items-center flex-row justify-between">
                                ...
                                <div className="bg-black rounded-full w-[18%] flex p-3 items-center justify-center">
                                    {banner.icon}
                                </div>
                            </Card>
                        </CarouselItem>
